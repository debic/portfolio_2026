    ...
    >
      ...
      <div ref={cursorRef} className="hero__custom-cursor" aria-hidden="true">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
          <path d="M4 2L20 10L12 13L9 21L4 2Z" fill="#111" stroke="#111" strokeWidth="1.5" strokeLinejoin="round"/>
        </svg>
      </div>
      ...
      <div className="hero__content">
        ...
        <h1 className="hero__title">
          <span className="hero__title--purple">Front End<br />Developer</span>
          {' '}&amp;{' '}<br />UX/UI Designer
        </h1>
        <Button variant="outline" size="md" href="#contact" className="hero__cta">
          Let's work together →
        </Button>
        ...
        <a href="#projects" className="hero__scroll-link">Latest work ▼</a>
      </div>
    </section>
  )
}
